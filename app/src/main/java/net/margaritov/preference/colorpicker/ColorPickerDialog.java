...
public class ColorPickerDialog
    ...
    private void setUp(int color) {
        ...
        mLayout = inflater.inflate(setResource("dialog_color_picker","layout"), null);
        mLayout.getViewTreeObserver().addOnGlobalLayoutListener(this);

        mOrientation = getContext().getResources().getConfiguration().orientation;
        setContentView(mLayout);

        setTitle(setResource("dialog_color_picker","string"));

        mColorPicker = (ColorPickerView) mLayout.findViewById(setResource("color_picker_view","id"));
        mOldColor = (ColorPickerPanelView) mLayout.findViewById(setResource("old_color_panel","id"));
        mNewColor = (ColorPickerPanelView) mLayout.findViewById(setResource("new_color_panel","id"));

        mHexVal = (EditText) mLayout.findViewById(setResource("hex_val","id"));
    ...
    public void onClick(View v) {
        if (v.getId() == setResource("new_color_panel","id")) {
            if (mListener != null) {
